...
This file defines a minimal GPT language model used by the project.
It is based on the original GPT-2 implementation and the
Hugging Face transformers reference code.
"""
